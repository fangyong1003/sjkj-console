      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="120px">
        ...
        <el-row>
          <el-form-item label="图片" prop="imgUrl">
            <el-input v-model="form.imgUrl" type="hidden"/>
            <el-upload
...
<script type="text/babel">
  ...
  export default{
    ...
    methods: {
      ...mapActions(['saveSysBanner', 'updateSysBanner', 'querySysBanners', 'upLoadPicBanner']),
      saveHandler() {
        let self = this;
      ...
      upload (item) {
        ...
        this.upLoadPicBanner(formData).then(data => {
          this.form.imgUrl = bannerStore.state.bannerUploadUrl;
