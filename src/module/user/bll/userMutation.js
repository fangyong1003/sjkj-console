...
const mutations = {
  ...
  [types.USER_LIST_QUERY_BEGIN](state) {
    state.userLists = [];
  },
  [types.USER_LIST_QUERY_SUC](state, {userLists}) {
    state.userLists = userLists.body.userHierarchyList;
    state.userListCount = userLists.body.totalCount;
  }
};
